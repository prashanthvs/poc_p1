...
class DatabricksConfig:
    ...
    def __init__(self, workspace_url: str, access_token: str, catalog: str, schema: str, volume: str, vector_search_endpoint: Optional[str], model_serving_endpoint: Optional[str]):
